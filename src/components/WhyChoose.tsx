      ...
      <div className="container max-w-[1260px] mx-auto px-6">
        ...
        >
          <div className="pre-title-wrap flex items-center gap-4">
            ...
            <ShinyText text="WHY CHOOSE US" speed={4} color="#858b94" shineColor="#a855f7" className="font-mono text-[11px] tracking-[0.3em] uppercase" />
            <div className="pre-title-line w-12 h-[1px] bg-[#1c1f26]"></div>
          </div>
        ...
        {/* Feature Grid — each card wrapped in Spotlight for cursor-follow glow */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((f, i) => (
            ...
            >
              <Spotlight
                className="h-full flex flex-col items-center text-center gap-5 p-8 rounded-[20px] border border-[#1c1f26] bg-[#0d1017] cursor-default"
